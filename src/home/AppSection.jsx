...
const desc = "Take shopping on your device with our app & learn all the time what you want. Just download and install to learn";

const AppSection = () => {
  return (
    <div className='app-section padding-td'>
